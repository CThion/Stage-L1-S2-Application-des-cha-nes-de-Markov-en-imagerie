...
metropolisIsing=function(forme, N, beta, B, alpha, L, n){
...
metropolisIsing("rectangle", 64, 1, 0, 1, 10, 10^4)
...
MCdeMC_Vstar=function(forme, N, beta, B, alpha, L, n){
  corresp = c(1,L)
  longueur = c(1:L)
  for( l in(1:L)){ corresp[l] = metropolisIsing(forme, N, beta, B, alpha, l, n) }#for
  rev <- data.frame(revo = c(1:L), correspondance = corresp )
  print(rev)
  ggplot(data = rev, aes(x="nombre_de_revolution", y="pourcentage de correspondance")) + geom_point() + geom_smooth() #+ geom_line()
}#func


MCdeMC_Vstar("rectangle", 64, 1, 0, 1, 20, 10^4)
#========================================================================================================
```
