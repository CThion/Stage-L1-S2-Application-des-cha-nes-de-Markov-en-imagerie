...
La longeur d'un branche est égale au nombre de pixels côte à côte de même valeur, partant de s.\ 
Le poid d'une branche de voisinage est alors proportionel à sa longeur. On aurait:
$U_s=\sum_{i=1}^{8}{a_il_i}$
...
2. pour chacun des lead, on regarde la valeur du pixel qui le jouxe dans l'orientation de la flêche auquel il appartient, opposément à s biensûr. Si ce pixel est de même valeur que le lead,
